...
class EvalTrajectory(Generic[InputsT, OutputT, MetadataT]):
    ...
    report_case: ReportCase | Any  # Can be ReportCase or ReportCaseFailure
    ...
    def make_reflective_dataset(
        ...
        for traj, score in zip(eval_batch.trajectories, eval_batch.scores):
            ...
            record: dict[str, Any] = {
                ...
                "expected_output": to_jsonable_python(case.expected_output) if hasattr(case, "expected_output") else None,
                "score": score,
            }
